...
:- object('be_dep_test#pid_a'(_),
    extends(process)).
		...
		% ---------------------------------------------------------------------------------------------------------------------							
			...
			(
				'be_dep_test#pid_a'(_)::actions_applicable(State, Action, Instance)
			)).
...
:- object('be_dep_test#pid_b'(_),
    extends(process)).
		...
		% ---------------------------------------------------------------------------------------------------------------------							
			...
			functional_constraint(necessity, [Action], State, Instance, 
			(
				'be_dep_test#pid_b'(_)::actions_applicable(State, Action, Instance)
			)).
		...
		% ---------------------------------------------------------------------------------------------------------------------
			...
			(	
				'be_dep_test#pid_a'(_)::exists_instance(State, finish, _)
			)).		
...
:- object('be_dep_test#pid_c'(_),
    extends(process)).
		...
		% ---------------------------------------------------------------------------------------------------------------------							
			...
			functional_constraint(necessity, [Action], State, Instance, 
			(
				'be_dep_test#pid_c'(_)::actions_applicable(State, Action, Instance)
			)).
...
:- object('be_dep_test#pid_d'(_),
    extends(process)).
		...
		% ---------------------------------------------------------------------------------------------------------------------							
			...
			functional_constraint(necessity, [Action], State, Instance, 
			(
				'be_dep_test#pid_d'(_)::actions_applicable(State, Action, Instance)
			)).
		...
		% ---------------------------------------------------------------------------------------------------------------------
			...
			(	
				'be_dep_test#pid_a'(_)::exists_instance(State, finish, _),
				'be_dep_test#pid_b'(_)::exists_instance(State, finish, _),
				'be_dep_test#pid_c'(_)::exists_instance(State, finish, _)
			)).
